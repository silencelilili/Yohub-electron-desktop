...
export class YohubEventManager {
  private static instance: YohubEventManager;
  ...
  static get shared(): YohubEventManager {
    if (!YohubEventManager.instance) {
      YohubEventManager.instance = new YohubEventManager();
    }
    return YohubEventManager.instance;
  }

  /**
   * 在全局注册 YohubEventManager
   */
  register() {
